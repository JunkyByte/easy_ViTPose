...
class MoEMlp(nn.Module):
    ...
    def forward(self, x, indices):
        ...
        # TODO: indices are currently not passed to inference.
        indices = torch.ones(self.experts[0](x).shape[0], device=x.device) * 5
        print(self.experts[0](x).shape, x.shape, indices.shape)
